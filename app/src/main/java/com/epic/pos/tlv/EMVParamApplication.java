...
public class EMVParamApplication extends EMVTLVParam
{
    ...
    public static int TAG_AppTermCap_9F33 = 0x9F33 ; //  "Terminal Capabilities Indicates the cardData data input, CVM, and security capabilities of the terminal"
    ...
    public static int TAG_DefaultDDOL_DF14 = 0xDF14 ; //  "Default Dynamic Data Authentication Data Object List (DDOL) DDOL to be used for constructing the INTERNAL AUTHENTICATE command if the DDOL in the cardData is not present"
