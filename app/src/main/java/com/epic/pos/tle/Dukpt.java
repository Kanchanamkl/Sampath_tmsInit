...
public class Dukpt extends TLEKeyGeneration{
    String szVariant="";
    byte[] unksn;//8
    byte[] unShift;//8
    ...
    public static Dukpt getInstance(String szSmartTid, int hostId) {
        if (instance == null)
            instance =  new Dukpt();
    ...
    int inNewKey3() {
        ...
        if(inintkey == 0) {
            ...
            keyindex = TLEKeyGeneration.inGETFUTUREKEYSLOTINDEX(host)+((20-inshiftBitIndex));
            ...
            keyindex = TLEKeyGeneration.inGETFUTUREKEYSLOTINDEX(host)+(inshiftBitIndex);
            TLEKeyGeneration.inStoreSecureAria(unDukptFK,keyindex);
        }
        inNewKey1();
        return 0;
    ...
    void inDiraveKeyMake() {
        ...
        inIndex     = TLEKeyGeneration.inGETFUTUREKEYSLOTINDEX(host) + (inshiftBitIndex);
    ...
    public void inUniqueKeyPerTxn(String ukID) {
        if(ukID.equals("03") || ukID.equals("04")) {
            inTxnDukptInit();
            szVariant = "0000000000FF0000";
            inDataEncriptionDecriptionKey();

            //for kcv
            szKvcForUniKey = szCurrentKvc(29);
            AppLog.i("IIIIIIIIIIIIIIIII ", "szKvcForUniKey = "+szKvcForUniKey);
        }
    }

    String szCurrentKvc(int inIndex) {
        String dummy = "0000000000000000";
        String key  = KeyManager.getKeyFromSlot(inIndex);
        AppLog.i("VVVVVVVVVVVVVVVV ", "key = "+key);
        byte[] encrypted = null;
        ...
        AppLog.i("VVVVVVVVVVVVVVVV ", "key = "+keyCheck);
        return keyCheck;
    }
