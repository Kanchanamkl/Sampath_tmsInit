...
public class ISO8583u extends ISO8583 {
    ...
    public static int [][] FIELD_ATTRIBUTE_ARRAY =
            {// type, length, not defined, not defined
                    ...
                    {	TYPE_LL_ASC	,	29, 0, 0	},	// field	61, 原始信息域(Original Message), N...029(LLLVAR)，3个字节的长度值＋最大29个字节的数字字符域，压缩时用右靠BCD码表示的2个字节的长度值＋用左靠BCD码表示的最大15个字节的数据。
    ...
    public static void changeVariantTypeofField(int fieldId, int type){
        FIELD_ATTRIBUTE_ARRAY[fieldId][0] = type;
    }
